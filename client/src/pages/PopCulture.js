...
const PopCulture = () => {
    const [popCulturePodcastData, setPodcastData] = useState('');
    useEffect(() => {
    ...
    let loading = true;
    if (popCulturePodcastData[0] !== undefined) {
        loading = false;
    }
    ...
    return (
        <ThemeProvider theme={theme} sx={{ bgcolor: '#f0eeeb', height: '100vh' }}>
            ...
            >
                <p className="wYl-font">POP CULTURE</p>
            ...
            >
                ...
                >
                    {popCulturePodcastData.map((podcast) => {
                        return (
